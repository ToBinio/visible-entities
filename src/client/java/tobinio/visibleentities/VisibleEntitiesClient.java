...
public class VisibleEntitiesClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        Config.HANDLER.load();
        EntityRendererFactories.register(EntityType.INTERACTION, InteractionEntityRenderer::new);
        EntityRendererFactories.register(EntityType.MARKER, MarkerEntityRenderer::new);
